    ...
    <?php
        ...
        function readPrev($fileAddr){
            ...
            while(!feof($fileHandler)){
                ...
                // $Fvalue = explode(":", fgets($fileHandler)); //Use explode
                // echo "<td>".$Fvalue[1]."</td>"; //Use explode
                $divideStr = fgets($fileHandler); //Use substr and strpos
                $value = substr($divideStr,strpos($divideStr,":")+1);//Use substr and strpos
                $value = trim($value); //Use substr and strpos
                echo "<td>".$value."</td>"; //Use substr and strpos
